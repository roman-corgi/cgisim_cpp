...
def run_hlc():
    ...
    for icase in range(ncase):
        ...
        rootname = 'hlc_ni_' + cases[icase]
        dm1 = proper.prop_fits_read( roman_preflight_proper.lib_dir + '/examples/'+rootname+'_dm1_v.fits' )
        dm2 = proper.prop_fits_read( roman_preflight_proper.lib_dir + '/examples/'+rootname+'_dm2_v.fits' )
        optval = {'cor_type':'hlc', 'use_errors':1, 'polaxis':10, 'final_sampling_lam0':final_sampling, \
    ...
    for i in range(ncase):
        ...
        circ_in = Circle((npsf/2,npsf/2),2.8/final_sampling,edgecolor='white', facecolor='none')
        circ_out = Circle((npsf/2,npsf/2),9.7/final_sampling,edgecolor='white', facecolor='none')
